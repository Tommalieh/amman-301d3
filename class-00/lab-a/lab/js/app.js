...
function displayPics(){
  ...
  // It's because using const to declare the variable made the variable owned inside the while scope so now it's local to while and only accessible inside it.
  console.log(viewed);
